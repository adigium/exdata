...
type RateLimitInfo = { exceeds: boolean; retryTime: number };
...
declare namespace ExchangeRequestContext {
  ...
  type Gate = EndpointLayersRequirements &
    WeightLayersRequirements &
    IpLayersRequirements &
    IdLayersRequirements & { type: 'margin' | 'public' | 'spot' | 'wallet' };

  type Kucoin = EndpointLayersRequirements &
    WeightLayersRequirements &
    IpLayersRequirements &
    IdLayersRequirements & { type: 'management' | 'public' | 'spot' };
  ...
  type Poloniex = EndpointLayersRequirements &
    WeightLayersRequirements &
    IpLayersRequirements &
    IdLayersRequirements & { type: 'private-heavy' | 'private-light' | 'public-10' | 'public-200' };
}
